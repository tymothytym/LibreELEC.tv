...
PKG_ARCH="x86_64"
PKG_LICENSE="GPL"
PKG_SITE="https://github.com/herrnst/dddvb-linux-kernel"
PKG_URL="http://mycvh.de/openelec/$PKG_NAME/$PKG_NAME-${PKG_VERSION}.tar.xz"
PKG_DEPENDS_TARGET=""
PKG_BUILD_DEPENDS_TARGET="toolchain linux"
PKG_PRIORITY="optional"
PKG_SECTION="driver"
PKG_SHORTDESC="Linux Digital Devices drivers"
PKG_LONGDESC="Linux Digital Devices drivers"
PKG_IS_ADDON="no"
PKG_AUTORECONF="no"
...
makeinstall_target() {
  mkdir -p $INSTALL/lib/modules/$KERNEL_VER/updates/dddvb

# does this anything ?
#  find $ROOT/$PKG_BUILD/media_build/v4l/ -name \*.ko -exec strip --strip-debug {} \;
  
  find $ROOT/$PKG_BUILD/media_build/v4l/ -name \*.ko -exec cp {} $INSTALL/lib/modules/$KERNEL_VER/updates/dddvb \;
}
